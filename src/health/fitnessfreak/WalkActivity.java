...
//		}
		...
		i.addAction("STEP_TAKEN");
		
		registerReceiver(intentReceiver, i);
		updateWalkDataonScreen(); 
		//startSensor();
...
//	}
	...
	private BroadcastReceiver intentReceiver = new BroadcastReceiver(){
		...
		public void onReceive(Context context, Intent intent) {
			// TODO Auto-generated method stub
			//Toast.makeText(context, "Step Taken", Toast.LENGTH_LONG).show();
			start.setText("Stop");
			updateWalkDataonScreen();
		}
		
	};
	public void updateWalkDataonScreen() {
...
//		Cursor csr = cf.getData(strQuery);
		...
		Log.i("Cursor Returned", "ind=side updateeeeeeeeeeeeeeeeeeeeeeeee");
		...
		if(x>0){
			...
			distance.setText(String.valueOf("0") + " kms");
			Cals.setText(String.valueOf("0") + " kCals");
		}
